  ...
  return !isLoading && iframeSrc ? (
    <iframe
      ...
      style={{
        ...
        border: 'none',
        marginTop: 'var(--app-header-offset)',
      }}
      title='Token Frame'
    ...
    <div
      className='fixed inset-0 z-[1000] flex h-screen w-screen items-center justify-center bg-white/80'
      style={{ marginTop: 'var(--app-header-offset)' }}
    >
